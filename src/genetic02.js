// Genetic.js - http://subprotocol.com/system/genetic-hello-world.html
// ex: https://github.com/subprotocol/genetic-js/blob/master/examples/string-solver.html
  ...
  Genetic.prototype.evolve = function (config, userData) {
    ...
    if (this.usingWebWorker) {
      ...
      worker.onerror = function (e) {
        window.alert('ERROR: Line ' + e.lineno + ' in ' + e.filename + ': ' + e.message)
      }
      worker.postMessage('')
    } else {
      // simulate webworker
